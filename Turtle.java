...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    public static void main(String[] a)
    {
        ...
        for(int i=0; i<6; i++) {
            ...
            bob.left(60); bob.forward(40);
            bob.backward(40); bob.right(60);

            bob.forward(60);
            bob.right(60); bob.forward(50);

            bob.right(45); bob.forward(20); bob.backward(20); bob.left(45);
            bob.left(45); bob.forward(20); bob.backward(20); bob.right(45);
            bob.backward(50); bob.left(60);

            bob.left(60); bob.forward(50);
            bob.right(45); bob.forward(20); bob.backward(20); bob.left(45);
            bob.left(45); bob.forward(20); bob.backward(20); bob.right(45);
            bob.backward(50); bob.right(60);

            bob.forward(60);
            bob.right(30); bob.forward(30); bob.backward(30); bob.left(30);
            bob.forward(30); bob.backward(30);
            bob.left(30); bob.forward(30); bob.backward(30); bob.right(30);
